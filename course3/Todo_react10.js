// the final version of fully functional App
// give each task, checked status and deleted status and print it out
// ID of each task is also shown
// when delete button or checkbox is clicked, the deleted/checked status will be change
// when delete button is clicked, the task will be removed
// counter function (total tasks, unfinished tasks) is added
